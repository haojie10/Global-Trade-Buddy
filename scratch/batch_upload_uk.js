...
const reportDir = 'D:\\我的APP\\客户档案\\西欧\\英国';
...
function uploadOne(filePath) {
  return new Promise((resolve) => {
    ...
    const regions = extractMeta(html, 'regions') || '英国, 欧洲';
    const products = extractMeta(html, 'products') || '照明产品, 五金';
...
async function run() {
  ...
  console.log(`Found ${files.length} HTML files to upload in ${reportDir}\n`);
