...
export default function MGLogo({ height = 24, className = '', color = 'var(--color-accent)' }: MGLogoProps) {
  ...
  const widthVal = typeof height === 'number' ? `${Math.round(height * (120 / 68))}px` : 'auto';
  ...
  return (
    ...
    >
      {/* 字母 M */}
      <path d="M 12,42 L 12,18 L 24,32 L 36,18 L 36,42" stroke={color} strokeWidth="3.5" strokeLinejoin="round" strokeLinecap="round" />

      {/* 中间图谱取景框 [ • ] */}
      {/* 左括号 */}
      <path d="M 55,20 H 50 V 40 H 55" stroke={color} strokeWidth="2.5" strokeLinejoin="round" strokeLinecap="round" />
      {/* 右括号 */}
      <path d="M 65,20 H 70 V 40 H 65" stroke={color} strokeWidth="2.5" strokeLinejoin="round" strokeLinecap="round" />
      {/* 中心核心实心圆点 */}
      ...
      {/* 字母 G */}
      <path d="M 106,22 A 10,10 0 1 0 106,38 V 30 H 98" stroke={color} strokeWidth="3.5" strokeLinejoin="round" strokeLinecap="round" />
    </svg>
  );
}
