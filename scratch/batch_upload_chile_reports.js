...
const reportDir = 'D:\\我的APP\\客户档案\\南美\\智利';
...
function uploadOne(filePath) {
  return new Promise((resolve) => {
    ...
    const regions = extractMeta(html, 'regions') || extractMeta(html, 'region') || '智利, 南美洲';
    const products = extractMeta(html, 'products') || extractMeta(html, 'product') || '家居用品, 家具, 五金, 建筑及装饰材料';
...
async function run() {
  ...
  console.log(`Found ${files.length} Chile reports to upload in ${reportDir}:\n`);
  ...
  console.log('\n========================================');
  console.log('         CHILE UPLOAD SUMMARY           ');
  console.log('========================================');
