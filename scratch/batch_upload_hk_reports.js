...
const reportDir = 'D:\\我的APP\\客户档案\\亚洲\\香港';
...
function uploadOne(filePath) {
  return new Promise((resolve) => {
    ...
    const regions = extractMeta(html, 'regions') || extractMeta(html, 'region') || '香港, 亚洲, 全球';
    const products = extractMeta(html, 'products') || extractMeta(html, 'product') || '家居用品, 日用百货, 纺织服装, 消费电子';
...
async function run() {
  ...
  console.log(`Found ${files.length} Hong Kong reports to upload in ${reportDir}:\n`);
  ...
  console.log('\n========================================');
  console.log('       HONG KONG UPLOAD SUMMARY         ');
  console.log('========================================');
